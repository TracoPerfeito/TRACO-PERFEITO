...
ALTER TABLE DENUNCIAS_PROJETOS
DROP FOREIGN KEY DENUNCIAS_PROJETOS_ibfk_2;

ALTER TABLE DENUNCIAS_PROJETOS
ADD CONSTRAINT DENUNCIAS_PROJETOS_ibfk_2
FOREIGN KEY (ID_PROJETO) REFERENCES PROPOSTA_PROJETO(ID_PROPOSTA)
ON DELETE CASCADE;
...
CREATE TABLE NOTIFICACOES (
    ...
    PREVIEW_NOTIFICACAO VARCHAR(255),             
    CONTEUDO_NOTIFICACAO TEXT NOT NULL,             
    ID_USUARIO INT NOT NULL,                        
    CATEGORIA_NOTIFICACAO VARCHAR(50),                
