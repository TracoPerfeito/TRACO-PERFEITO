...
CREATE TABLE VISUALIZACOES_PUBLICACAO (
  ...
  ID_PUBLICACAO INT NOT NULL,
  ID_USUARIO INT NULL, -- pode ser null se o visitante não estiver logado
  DATA_VISUALIZACAO DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  TOKEN_SESSAO VARCHAR(100) NULL AFTER ID_USUARIO,
...
CREATE TABLE DENUNCIAS_PROJETOs (
    ...
    FOREIGN KEY (ID_PROJETO) REFERENCES PROPOSTA_PROJETO(ID_PROPOSTA)
);

RENAME TABLE DENUNCIAS_PROJETOs TO DENUNCIAS_PROJETOS;


CREATE TABLE NOTIFICACOES (
    ID_NOTIFICACAO INT AUTO_INCREMENT PRIMARY KEY,
    TITULO_NOTIFICACAO VARCHAR(255) NOT NULL,
    CONTEUDO_NOTIFICACAO TEXT NOT NULL,          -- pode conter HTML
    ID_USUARIO INT NOT NULL,          -- usuário que recebeu
    CATEGORIA_NOTIFICACAO VARCHAR(50),            -- exemplo: "mensagem", "proposta", "post"
    STATUS VARCHAR(20) DEFAULT 'NAO_LIDA', -- "NAO_LIDA" ou "LIDA"
    DATA_CRIACAO_NOTIFICACAO TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
